...
<div id="wrapper">
		...
		<div class="top-area">
			<div class="container">
				<div class="row">
					...
					<p class="bold text-left">Sunday - Saturday, 8am to 10pm </p>
					</div>
					<div class="col-sm-6 col-md-6">
    ...
    <section id="service" class="home-section nopadding paddingtop-60">
        ...
        <div class="row">
			<div class="col-sm-6 col-md-6">
				<div class="wow fadeInUp" data-wow-delay="0.2s">
				<img src="assest/img/dummy/img-1.jpg" class="img-responsive" alt="" />
				</div>
            </div>
			<div class="col-sm-3 col-md-3">
                ...
                <ul>
                    <li class="cbp-item psychiatrist">
                        <a href="doctors/member1.html" class="cbp-caption cbp-singlePage">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assest/img/team/1.jpg" alt="" width="100%">
                            </div>
                    ...
                    <li class="cbp-item cardiologist">
                        <a href="doctors/member2.html" class="cbp-caption cbp-singlePage">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assest/img/team/2.jpg" alt="" width="100%">
                            </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <li class="cbp-item cardiologist">
                        <a href="doctors/member3.html" class="cbp-caption cbp-singlePage">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assest/img/team/3.jpg" alt="" width="100%">
                            </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <li class="cbp-item neurologist">
                        <a href="doctors/member4.html" class="cbp-caption cbp-singlePage">
                            <div class="cbp-caption-defaultWrap">
                                <img src="assest/img/team/4.jpg" alt="" width="100%">
                            </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
			...
			<div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" >
                    ...
                    <div id="owl-works" class="owl-carousel">
                        <div class="item"><a href="assest/img/photo/1.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="assest/img/works/1@2x.jpg"><img src="assest/img/photo/1.jpg" class="img-responsive" alt="img"></a></div>
                        <div class="item"><a href="assest/img/photo/2.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="assest/img/works/2@2x.jpg"><img src="assest/img/photo/2.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="assest/img/photo/3.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="assest/img/works/3@2x.jpg"><img src="assest/img/photo/3.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="assest/img/photo/4.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="assest/img/works/4@2x.jpg"><img src="assest/img/photo/4.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="assest/img/photo/5.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="assest/img/works/5@2x.jpg"><img src="assest/img/photo/5.jpg" class="img-responsive " alt="img"></a></div>
                        <div class="item"><a href="assest/img/photo/6.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="assest/img/works/6@2x.jpg"><img src="assest/img/photo/6.jpg" class="img-responsive " alt="img"></a></div>
                    </div>
					</div>
                </div>
            </div>
...
<a href="#" class="scrollup"><i class="fa fa-angle-up active"></i></a>
	...
	<script src="assest/js/jquery.scrollTo.js"></script>
	<script src="assest/js/jquery.appear.js"></script>
	<script src="assest/js/stellar.js"></script>
	<script src="assest/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
	<script src="assest/js/owl.carousel.min.js"></script>
	<script src="assest/js/nivo-lightbox.min.js"></script>
